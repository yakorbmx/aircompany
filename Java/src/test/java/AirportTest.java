...
public class AirportTest {
  ...
  public void testGetTransportMilitaryPlanes() {
    ...
    for (MilitaryPlane militaryPlane : transportMilitaryPlanes) {
      assertTrue(militaryPlane.getType() == MilitaryType.TRANSPORT);
    }
  }
  ...
  public void testGetPassengerPlaneWithMaxCapacity() {
    ...
    PassengerPlane expectedPlaneWithMaxPassengersCapacity =
        airport.getPassengerPlaneWithMaximalPassengersCapacity();
    assertTrue(expectedPlaneWithMaxPassengersCapacity.equals(planeWithMaxPassengerCapacity));
  }

  @Test
  public void testIsSortingOfMaximalLoadCapacityCorrect() {
    Airport airport = new Airport(planes);
  ...
  public void testHasAtLeastOneBomberInMilitaryPlanes() {
    ...
    for (MilitaryPlane militaryPlane : bomberMilitaryPlanes) {
      assertTrue(militaryPlane.getType() == MilitaryType.BOMBER);
    }
  }
